...
@section('content')
				<div class="container">
					<div class="row">
						<div class="col-sm-12 col-md-6">
							<h3 class="text-left">ReFill Data</h3><br>
						</div>
						<!--<div class="col-sm-12 col-md-6">
        ...
        @if(session()->has('alert_msg'))
            <div class="alert alert-warning alert-dismissible fade show" role="alert">
		        ...
		        @endif
		<form class="form" action="{{url('/admin-refill-data/'.$refill->uuid) }}" method="post">
			@csrf
			...
			<div class="row">
				<div class="col-sm-4">
<!--					<input type="text" class="form-control" name="buy_sell" placeholder="Buy/Sell" value="{{ $refill->buy_sell }}">-->
				...
				<div class="col-sm-12 col-md-4">
					<select   name="delivery_place" class="form-control">
	                    ...
	                    <option
	                    <?php
				    		if($refill->delivery_place == 'Regular')
				    		{
				    			echo "selected";
				    		} 
				    	?> 
			    ...
			    <div class="col-sm-12 col-md-4">
					<select   name="tar_of_busi_area" class="form-control">
	                    ...
	                    <option
	                    <?php
				    		if($refill->tar_of_busi_area == 'Prefured Location')
				    		{
				    			echo "selected";
				    		} 
				    	?> 
	                    >Prefured Location</option>
	                 </select>
			    </div>
