    ...
    <div class="container">
		<div class="row">
			<div class="col-sm-12 col-md-6">
				<h3 class="text-left">Company Info  (Search Result According Phone No.) </h3><br>
			</div>
			<div class="col-sm-12 col-md-6">
				<a  type="btn" class="btn btn-secondary float-right" href="{{ url('admin_company') }}"> Back</a>
			</div>
		</div>
	</div>
 	...
 	<div class="row">
 		<div class="col-sm-12 col-md-12">
 			...
 			<table class="table table-hover">
                @if(strlen($searchCom)>0)
                
                @foreach($searchCom as $company)
                <tr>
               ...
               <tr>
                ...
                <tr>
                    ...
                    <td><a href="{{ $company->bwt_catalog_link }}">{{ $company->bwt_catalog_link }} </a></td>
                </tr>
                <tr>
            ...
            @endif
             ...
             <div class="container">
                ...
                <div class="row">
                    @foreach($searchCom as $company)
                        <div class="col-sm-12 col-md-6">
                            <a class="btn btn-success" href="{{url('/admin-comment/'.$company->uuid)}}">Update</a>
                        </div>
                        <div class="col-sm-12 col-md-6">
                            <a class="btn btn-success" href="{{url('/admn-refill/'.$company->uuid)}}">ReFill</a>
                        </div>
                    @endforeach
                </div>
