    ...
    <div id="product-search" class="container">
      ...
      <div class="row">
         <div id="content" class="col-sm-12">
         	@foreach($searches->take(1) as $searchproduct)
            ...
            <br><br>
            <div class="row">
               @foreach($searches as $searchproduct)
               <div class="product-layout product-list">
                  <div class="product-thumb transition  options ">
                     ...
                     <div class="prod-caption">
                        <div class="name" data-match-height="items-n"><a>{{ $searchproduct->name	 }}</a></div>
