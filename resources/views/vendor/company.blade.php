...
<section id="Add New Company Start">
		...
		<form class="form" action="{{ url('data') }}" method="post">
			...
			<div class="row">
			    ...
			    <div class="col-sm-12 col-md-6">
					<input type="hidden" name="datedata" value="<?php echo date('Y-m-d'); ?>">
			    </div>
           ...
           <h6><mark>Company Details</mark></h6>
			<div class="row">
			    ...
			    <div class="col-sm-12 col-md-12">
					<select   name="firm_type" class="form-control" >
	                    ...
	                    <option value="Startup Planing">Startup Planing</option>
            ...
            <br>
			<div class="row">
			    <input type="button" value="Show/Hide" onClick="showHideDiv('divMsg')"/><br>
			...
			<div class="row">
				...
				<div class="col-sm-12 col-md-4">
					<select   name="status" class="form-control">
	                    ...
	                    <option value="Lang.B">Lang.B</option>
			...
			<input type="button" value="Show/Hide (Company Documents)" onClick="showHideDiv2('divMsg2')"/>
				<div id="divMsg2"  style="display:none"><br>
			<h6 class="mb-3"><mark>Company Documents</mark></h6><br>
			<div class="row">
            ...
            <input type="button" value="Show/Hide (Optional Documents)" onClick="Optionaldoc('Optional')"/>
				<div id="Optional"  style="display:none"><br>
    ...
    <!--<center>
        ...
        <div id="divMsg" style="background-color: #006969; color: #ffffff;
                                height: 200px; width:200px; text-align: center; display:none">
                <h2>jdfjdhf</h2>
        </div>
    </center>-->
