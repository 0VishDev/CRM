...
<div class="container">
    <div class="row">
        <div class="col-sm-12 col-md-6">
           <h3 class="text-left">Company All Info</h3><br>
        </div>
        <!-- <div class="col-sm-12 col-md-4">
            @foreach($allcompany as $company)
            <h3 class="text-left"> <mark>{{ $company->company_name }} </mark></h3><br>
            @endforeach
        </div> -->
        <div class="col-sm-12 col-md-6">
 	...
 	<div class="row">
 		<div class="col-sm-12 col-md-12">
 			<table class="table table-hover">
                ...
                <tr>
                    <th><span>3. </span>Package Name</th>
            ...
            <div class="container">
                <!--<div class="row">
                    @foreach($allcompany as $company)
                    <div class="col-sm-12 col-md-6 mycmnt">
                        <p style="color:red;">Comment ( By Employee About Client)</p>
                     </div>
                    <div class="col-sm-12 col-md-6 ">
                       
                    <p><mark>{{ $company->comment }}</mark></p>
                    <br>
                    </div>
                ...
                <div class="row">
                    <input type="button" value="Show/Hide Comment" onClick="showHideComnt('divMsg')"/><br>
                    <div id="divMsg" style="display:none"class="col-sm-12 col-md-12">
                            @foreach($allcompany as $company)
                ...
                <div class="row">
                    @foreach($allcompany as $company)
                        <div class="col-sm-12 col-md-6">
                            <a class="btn btn-success" href="{{url('/comment/'.$company->uuid)}}">Update</a>
                        </div>
                        <div class="col-sm-12 col-md-6">
                            <a class="btn btn-success" href="{{url('/refill1/'.$company->uuid)}}">ReFill</a>
                        </div>
                    @endforeach
                </div>
